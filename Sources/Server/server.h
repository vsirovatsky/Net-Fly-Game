...
private:
	...
	void on_event_game_ping(const CL_NetGameEvent &e, ServerUser *user);
	void on_event_game_userstate(const CL_NetGameEvent &e, ServerUser *user);
	void on_event_game_playerhit(const CL_NetGameEvent &e, ServerUser *user);
private:
